...
var HTMLprojectImage = '<img src="%data%" class="proimg">';
...
var HTMLschoolMajor = '<h5><em><br>Major: %data%</em></h5>';
var HTMLschoolURL = '<br><a hreg = "%data%">%data%</a>';

var HTMLonlineStart = '<div class="online-entry"></div>';
var HTMLonlineClasses = '<h3 class="center">Online Classes</h3>';
